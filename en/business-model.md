...
**Navigation:** [← Table of contents](../profile/README.md) · [For investors](for-investors.md) · [Financial calculations](financial-calculations.md) · [Roadmap](roadmap.md)
...
First accelerator target: 21,000+ entrepreneurs. Scaling scenarios — see [market-analysis.md](market-analysis.md).
...
2. **From portfolio company exits** — sale of governance tokens on exit (exit rate 10–20%, return 10–15x)
...
Detailed calculations: [financial-calculations.md](financial-calculations.md)
...
More: [roadmap.md](roadmap.md)

### Financial Forecasts

Detailed returns, scenarios (conservative / optimistic), and stress tests — see [financial-calculations.md](financial-calculations.md) and [for-investors.md](for-investors.md).
...
Full risk analysis: [for-investors.md](for-investors.md) · [DISCLAIMERS.md](DISCLAIMERS.md)
