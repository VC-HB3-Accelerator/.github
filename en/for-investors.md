**Language:** [English](../en/for-investors.md) | [Русский](../ru/for-investors.md)
...
- DLE platform: https://github.com/VC-HB3-Accelerator/DLE
...
More on fund business model and revenue: [business-model.md](business-model.md)
...
Detailed returns: [financial-calculations.md](financial-calculations.md)
...
More: [5-year roadmap](roadmap.md)
...
5. **Read documentation:** [business-model.md](business-model.md), [governance.md](governance.md), [financial-calculations.md](financial-calculations.md)
...
Exit terms: [financial-calculations.md](financial-calculations.md)

---

## Additional Materials

- [Business model](business-model.md) — revenue sources, profit distribution
- [Financial calculations](financial-calculations.md) — return examples, liquidity mechanism
...
> Investing in cryptocurrencies and tokens involves high risks. Conduct thorough Due Diligence and consult financial advisors. More: [DISCLAIMERS.md](DISCLAIMERS.md)
